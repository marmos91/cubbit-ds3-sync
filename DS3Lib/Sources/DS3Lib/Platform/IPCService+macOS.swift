...
final class MacOSIPCService: IPCService, @unchecked Sendable {
    ...
    init() {
        ...
        (extensionInitFailures, extensionInitFailureContinuation) = AsyncStream.makeStream(of: IPCExtensionInitFailure.self)
    }
    ...
    func startListening() async {
        ...
        registerJSONObserver(center: center, decoder: decoder, name: .driveStatusChanged, continuation: statusContinuation)
        registerJSONObserver(center: center, decoder: decoder, name: .driveTransferStats, continuation: transferContinuation)
        ...
        registerJSONObserver(center: center, decoder: decoder, name: .conflictDetected, continuation: conflictContinuation)
    ...
    private func postJSON<T: Encodable>(_ value: T, notificationName: NSNotification.Name) {
