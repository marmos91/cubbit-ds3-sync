...
public extension SharedData {
    ...
    /// `SharedDataError.ds3DriveNotFound` if the drive with the given id cannot be found. Other error can be thrown if
    /// reading and decoding fails
    func loadDS3DriveFromPersistence(
        withId id: UUID
    ) throws -> DS3Drive {
