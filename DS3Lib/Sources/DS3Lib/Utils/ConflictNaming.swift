...
public enum ConflictNaming: Sendable {
    ...
    ///   - nonce: A short random suffix for collision avoidance (auto-generated by default)
    /// - Returns: A new S3 key with conflict suffix inserted before the extension
    public static func conflictKey(originalKey: String, hostname: String, date: Date, nonce: String = String(UUID().uuidString.prefix(4).lowercased())) -> String {
