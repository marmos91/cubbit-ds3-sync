...
public extension SharedData {
    ...
    func persistTenantName(_ tenant: String) throws {
    ...
    func loadTenantNameFromPersistence() throws -> String {
        let tenantURL = try sharedContainerURL().appendingPathComponent(DefaultSettings.FileNames.tenantFileName)
    ...
    /// - Throws: `SharedDataError.cannotAccessAppGroup` if the app group cannot be accessed.
    func deleteTenantNameFromPersistence() throws {
        let tenantURL = try sharedContainerURL().appendingPathComponent(DefaultSettings.FileNames.tenantFileName)
    ...
    /// - Throws: `SharedDataError.cannotAccessAppGroup` if the app group cannot be accessed.
    func persistCoordinatorURL(_ coordinatorURL: String) throws {
        let urlFileURL = try sharedContainerURL()
            .appendingPathComponent(DefaultSettings.FileNames.coordinatorURLFileName)
    ...
    func loadCoordinatorURLFromPersistence() throws -> String {
        let urlFileURL = try sharedContainerURL()
            .appendingPathComponent(DefaultSettings.FileNames.coordinatorURLFileName)
    ...
    /// - Throws: `SharedDataError.cannotAccessAppGroup` if the app group cannot be accessed.
    func deleteCoordinatorURLFromPersistence() throws {
        let urlFileURL = try sharedContainerURL()
            .appendingPathComponent(DefaultSettings.FileNames.coordinatorURLFileName)
