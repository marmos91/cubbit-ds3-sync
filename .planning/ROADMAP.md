...
- [x] 17.1-02-PLAN.md -- DS3Native P/Invoke bindings + DS3DriveS3Client facade (owns/disposes the handle) + DS3AccountInfo.EndpointGateway + remove DS3Session S3-method stopgap (the AVE fix)
